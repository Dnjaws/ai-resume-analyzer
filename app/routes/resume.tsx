        ...
        <main className="!pt-0">
            <nav className="resume-nav">
                <Link to="/" className="back-button">
                    ...
                    <span className="font-semibold text-gray-600 text-lg">Back to Homepage</span>
                </Link>
            </nav>
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                <section className="feedback-section flex bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center">
                    {imageUrl && resumeUrl && (
                ...
                <section className="feedback-section">
                    ...
                    {feedback ? (
                        <div className="flex flex-col gap-8 animate-in fade-in duration-1000">
                            ...
                            <ATS score={feedbak.ATS.score || 0} suggestions={feedback.ATS.tips || []}/>
